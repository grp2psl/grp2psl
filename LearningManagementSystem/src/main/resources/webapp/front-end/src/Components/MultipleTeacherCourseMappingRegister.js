...
class MultipleTeacherCourseMappingRegister extends React.Component{	
    ...
    async download(){
		...
		try{
			const response = await axios.get(DATABASE_URL+TCMAPPING_URL+"/generate-excel");
    ...
    async assignTrainers(){
        ...
        if(this.state.file != null){
            ...
            try{
                const response = await axios.post(DATABASE_URL+TCMAPPING_URL+"/register-multiple", formData, config);
